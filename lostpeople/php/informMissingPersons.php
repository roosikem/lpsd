...
if (isset($_POST['firstName'])) {
    ...
    if (isset($_POST['person_id'])) {
             ...
             $result = mysql_query("UPDATE LFPERSON person set person.name='$firstName', person.fathersname='$fatherName', person.mothersname='$motherName', 
                       person.gender='$gender',person.age='$age', person.religion='$religion', person.image_name='$image_name', 
	     ...
	     $result = mysql_query("INSERT INTO LFPERSON(name,fathersname,mothersname,gender,age,religion,person_image,thumbnail,person_login_id,create_date,update_date,report_type) 
                    VALUES('$firstName','$fatherName','$motherName','$gender','$age','$religion','$user_image','$thumbnail','$login_id',NOW(),NOW(),'$reportType')");
                    if ($result) {
