...
INNER JOIN LFIDENTIFICATION_MARKS lfIdenti ON person.person_id = lfIdenti.person_id where person.person_login_id='$loginId' and person.report_type='$reportType' ";
...
$sql =" SELECT person.person_id,person.name,person.fathersname,person.mothersname,person.gender,person.age,person.religion,person.report_type,person.person_login_id,person.create_date,person.update_date,person.image_name FROM LFPERSON person where person.person_login_id='$loginId' and person.report_type='$reportType' LIMIT $pageLimit, 8";
